...
class Curl extends CApplicationComponent
{
    ...
    protected function defaults()
    {
        ...
        isset($this->options['setOptions'][CURLOPT_SSL_VERIFYPEER]) ? $this->setOption(
            CURLOPT_SSL_VERIFYPEER,
            $this->options['setOptions'][CURLOPT_SSL_VERIFYPEER]
    ...
    public function getBody()
    {
        ...
        return trim(substr($this->data, $headerSize));
    }
    ...
    private function handleCurl($url, $post_data = array())
    {
        ...
        if (empty($post_data)) {
            ...
            //curl_setopt_array($this->ch, $post_data);
        }
